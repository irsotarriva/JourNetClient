            ...
            <div className="relative z-10 w-full max-w-md mx-4">
                ...
                <div className="bg-white/40 backdrop-blur-md rounded-2xl p-8 shadow-xl border border-white/30">
                    <form onSubmit={handleSubmit} className="space-y-6">
                        ...
                        {/* Caution Message */}
                        {!isLogin && (
                            <div className="bg-yellow-50/90 backdrop-blur-sm border-2 border-yellow-200 text-yellow-700 px-4 py-3.5 rounded-xl text-sm animate-slide-down shadow-sm mb-4">
